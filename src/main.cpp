    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          double px = j[1]["x"];
          double py = j[1]["y"];
          // angle (direction) of the car and speed
          double psi = j[1]["psi"];
          double v = j[1]["speed"];
          ...
          // for visual effect and debugging - yellow line
          vector<double> next_x_vals;
          vector<double> next_y_vals;

          // set parameters (distance and total points)
          double poly_inc = 2.5;
          double num_points = 25;
          // calculate x and y values of yellow line
          ...
          // for visual effect and debugging - green line
          vector<double> mpc_x_vals;
          vector<double> mpc_y_vals;

          // take all x and y values from vars besides the first two
